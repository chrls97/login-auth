  ...
  return (
    <section className='w-full px-[5%]'>
      <div className='flex flex-col items-center justify-center gap-2 max-w-[1520px] mx-auto'>
        ...
        <h1 className='flex justify-center items-center gap-2 text-3xl font-semibold text-gray-800' >Hey {userData ? userData.name : 'Developer'} <img src={assets.hand_wave} alt="Hand" className='w-8 aspect-square' /></h1>
